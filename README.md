...
This repository dogfoods MindPlan. The live territory is under [`mindplan/`](mindplan/); the Mermaid map below is also saved as [`mindplan-map.md`](mindplan-map.md).
